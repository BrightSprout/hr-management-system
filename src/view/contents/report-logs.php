<div class="p-4 sm:p-6">
    ...
    <header class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-50 rounded-2xl border border-gray-200 shadow-md p-5">
        ...
        <button
            ...
            class="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md shadow-sm hover:bg-blue-700 transition text-sm font-medium cursor-pointer">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            <div class="relative w-full sm:w-64">
                ...
                <select id="employeeDropdown"
                    class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-700 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                >
                    <option value="all">All Employees</option>
                    <!-- CAN WE QUERY ALL STAFFS HERE? -->
                    <!-- YES, WE CAN :) -->
                </select>
            </div>
        </div>
